...
solution {
    ...
    track {
        position = 1 to -2
        positions = listOf(4 to -1, 3 to 0, 2 to 0, 1 to 0, 0 to 0, -1 to 0, -2 to 0, -2 to 1, -1 to 1)
    }
    track {
        position = -11 to 12
    ...
    track {
        position = -2 to 4
        positions = listOf(-1 to 0, -2 to 0, -3 to 0, -2 to -1, -1 to -1)
    }
    track {
        position = 12 to 3
    ...
    track {
        position = -2 to -2
        positions = listOf(2 to -1, 1 to -1, 0 to 0, 0 to -1, -1 to 0, -1 to -1, -2 to 0)
    }
    track {
        position = 0 to 6
        positions = listOf(1 to -2, 0 to -1, 0 to 0, -1 to 1)
    }
    tape {
        parallel(
        {
