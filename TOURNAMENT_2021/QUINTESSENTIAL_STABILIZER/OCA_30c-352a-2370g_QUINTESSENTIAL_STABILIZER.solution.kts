...
solution {
    ...
    track {
        position = 5 to -6
        positions = listOf(0 to 0, 0 to 1, 1 to 1, 0 to 2, -1 to 2, -1 to 1)
    }
    track {
        position = 10 to -5
    ...
    track {
        position = -3 to -10
        positions = listOf(0 to 1, -1 to 2, -1 to 1, -1 to 0, -2 to 0, -3 to 1, -2 to 1)
    }
    track {
        position = 2 to 9
        positions = listOf(0 to -1, 1 to -2, 1 to -1, 1 to 0, 2 to 0, 3 to -1, 2 to -1)
    ...
    track {
        position = 1 to -5
        positions = listOf(0 to -3, 0 to -2, 0 to -1, 0 to 0, 0 to 1)
    }
    track {
        position = -2 to 4
        positions = listOf(0 to 3, 0 to 2, 0 to 1, 0 to 0, 0 to -1)
